  ...
  return (
    Object.entries(t).forEach(([n, d]) => {
      ...
      n === 'neutral'
        ...
        : l.includes(n)
        ? (r = `.${e}::${n}`)
        : (console.error(`Invalid pseudo class: ${n}`), console.log(i, l, n, n in i, n in l)),
...
function H(e) {
  const { children: t, pseudo: s, className: c, ...n } = e,
    [d] = o(s, e.pseudoId)
  return /* @__PURE__ */ a('button', { className: `${c ?? ''} ${d}`, ...n, children: t })
}
function A(e) {
  const { children: t, pseudo: s, className: c, ...n } = e,
    [d] = o(s, e.pseudoId)
...
export {
  ...
  Ls as FeBlend,
  Ds as FeColorMatrix,
  Ps as FeComponentTransfer,
  xs as FeComposite,
  Bs as FeConvolveMatrix,
  Hs as FeDiffuseLighting,
  As as FeDisplacementMap,
  Es as FeDistantLight,
  Gs as FeFlood,
  Rs as FeGaussianBlur,
  qs as FeImage,
  Us as FeMerge,
  Vs as FeMergeNode,
  Ws as FeMorphology,
